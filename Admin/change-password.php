                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            <ul class="ps-0 mb-4 list-unstyled d-flex flex-wrap gap-2 gap-lg-3">
                                <li>
                                    <a href="user_profile.php" class="btn btn-primary border border-primary bg-transparent text-primary py-2 px-3 fw-semibold">Account Settings</a>
                                </li>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group">
                                                <div class="password-wrapper position-relative">
                                                    <input type="password" id="password" class="form-control h-55 text-dark" value="@password#" disabled>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group">
                                                <div class="password-wrapper position-relative">
                                                    <input type="password" id="password" class="form-control h-55 text-dark" >
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group d-flex gap-3 align-items-center">
                                            <button type="submit" class="btn btn-primary py-2 px-4 fw-medium fs-16"> <span class="material-symbols-outlined">
fingerprint
</span> Change Password</button>    <i class="ri-check-line text-white fw-medium"></i>
                                        </div>
                                    </div>
                                </div>     
                            </form>
