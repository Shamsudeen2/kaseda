...
<div class="main-content-container overflow-hidden">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                <li class="breadcrumb-item">
                                    <a href="user-profile.html#" class="d-flex align-items-center text-decoration-none">
                    ...
                    <div class="position-relative">
                        ...
                        <div class="position-absolute for-rtl-position" style="bottom: 25px; right: 25px;">
                            <a href="user-profile.html#" class="btn btn-outline-light text-white hover rounded-2">
                                Update Cover Photo
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-3">
                                <div class="d-flex align-items-end">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span class="fs-15 fw-medium">Active</span>
                                    </div>
                                 

                                </div>
                                <div class="d-flex align-items-center">
                                    <a href="user-profile.html#" class="btn btn-outline-danger text-body fw-medium fs-16 px-4 hover hover-bg">
                                    <i class="ri-alert-line"></i>
                                        <span>Banned</span>
                                    </a>
                                    <a href="user-profile.html#" class="btn btn-primary fw-medium fs-16 px-4 ms-3">
                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            <ul class="ps-0 mb-4 list-unstyled d-flex flex-wrap gap-2 gap-lg-3">
                                <li>
                                    <a href="user_profile.php" class="btn btn-primary border border-primary bg-primary text-white py-2 px-3 fw-semibold">Account Settings</a>
                                </li>
                                <li>
                                    <a href="change-password.php" class="btn btn-primary border border-primary bg-transparent text-primary py-2 px-3 fw-semibold">Change Password</a>
                                </li>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="fs-15">Update  Users  personal details here.</p>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-55" placeholder="first name">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-55" placeholder="last name">
                                                <i class="ri-user-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="email" class="form-control text-dark ps-5 h-55" placeholder="example@gmail.com">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-55" placeholder="09136616265">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-55" placeholder="Address">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <select class="form-select form-control ps-5 h-55" aria-label="Default select example">
                                                    <option selected class="text-dark">Nigeria</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-55" value="" placeholder="state">
                                                <i class="ri-user-location-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            <label class="label text-secondary">Package</label>
                                            <div class="form-group position-relative">
                                                <select class="form-select form-control ps-5 h-55" aria-label="Default select example">
                                                    <option selected class="text-dark">API</option>
                                                    <option value="1" class="text-dark">SMART</option>
                                                    <option value="2" class="text-dark">RESELLER</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group d-flex gap-3 align-items-center">
                                            <button type="submit" class="btn btn-primary py-2 px-4 fw-medium fs-16"> <i class="ri-check-line text-white fw-medium"></i>Update User</button>
                                        </div>
                                    </div>
